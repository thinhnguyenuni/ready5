...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
 ...
 <div class="col-12 text-uppercase h2 text-center text-success ">Cập nhật</div>
          <div class="p-4">
              <form:form action="${pageContext.request.contextPath}/update" method="post" modelAttribute="detail" id="inputForm">
                  <div class="form-group row">
                      <form:label path="id" for="inputID" class="col-sm-3 col-form-label">Mã</form:label>
                      <div class="col">
                          <form:input path="id" type="text" class="form-control" id="inputID" placeholder="Mã (KHxxxxx)" readonly="true"/>
                          <form:errors path="id" />
