...
<!--                   </li> -->
                   ...
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/xe/create">Nhập xe</a></li>
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/giaodich/create">Nhập lịch trình</a></li>
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/giaodich/list">Thông tin Lịch trình</a></li>
              	   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/giaodich/money">Tổng tiền thu nhập</a></li>
              </ul>
          </div>
      </div>
  </nav>
